export const filteredResults = (state) => state.filter.filteredResults;
export const allResults = (state) => state.loading.allResults;
export const categories = (state) => state.loading.categories;
export const pageState = (state) => state.page.pageState;
